 ...
 */
class Tx_Generic_Domain_Model_Thoroughfare extends Tx_Generic_Domain_Model_Name {

	/**
	 * @var Tx_Generic_Domain_Model_Type_ThoroughfareType
	 */
	protected $type;
	
	/**
	 * subThoroughfare
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_Generic_Domain_Model_Thoroughfare>
	 */
	protected $subNames;
